...
Comparing Figure 1 and Figure 2, whether the model is correctly predicting from human-intuitive feature is not apparent in Figure 2. %effect is not made transparenet.
...
%
%Learning from users with more tweets helps embedding a whole tweet?
